...
<div class="conWrap">
    <div class="opWrap">
        ...
        <div class="searchWrap">
            ...
            <p class="txtWrap">
                <span class="txtName">车牌号：</span>
                <input type="text" placeholder="请输入车牌号">
            </p>
            <p class="txtWrap">
                <span class="txtName">起止日期：</span>
                <input type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-{%d}',minDate:'%y-%M-{%d-91}'})"/>
                <span>-</span>
                <input type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-{%d}',minDate:'%y-%M-{%d-91}'})"/>
            </p>
            <a class="opBtn">
            ...
            <a class="opBtn" href="${ctx}/admin/security/add">
                <img width="16" height="16" src="sichuang/images/clear_icon.png" />
                &nbsp;新增
            </a>
            <#--id=所选中的数据id 待添加-->
            <a class="opBtn" href="${ctx}/admin/security/delete?id=?" target="ajaxTodo" callback="securityReload();" data-body="确认要删除吗？">
                <img width="16" height="16" src="sichuang/images/clear_icon.png"/>
                &nbsp;删除
            </a>
        </div>
